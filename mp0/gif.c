/**
 * GIF encoding and decoming library.
 ...
 *   - Added `illinify` functionality and relatied utility functions.
...
read_num(int fd)
{
    ...
    read(fd, bytes, 2); /* Hmm, maybe I should reread the documentation for C's read() call... */
